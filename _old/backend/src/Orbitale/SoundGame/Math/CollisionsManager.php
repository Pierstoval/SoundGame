...
namespace Orbitale\SoundGame\Math;

use Orbitale\SoundGame\Geometry\Circle;
use Orbitale\SoundGame\Geometry\Rectangle;
...
final class CollisionsManager
{
    ...
    {
        $deltaX = $circleA->getCenterPoint()->getX() - $circleB->getCenterPoint()->getX();
        $deltaY = $circleA->getCenterPoint()->getY() - $circleB->getCenterPoint()->getY();
    ...
    /**
     * Test if rectangleA collides with rectangleB.
     *
